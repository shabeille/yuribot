...
class SafebooruBrowser:
    def __init__(self, session, cache_size=1000, default_tags=None, fetch_from_latest: bool = False):
        ...
        if not fetch_from_latest:
            self.default_tags.append("sort:random") # randomises! :3 took me WAY too long to remember that this exists
